...
public class TrainingProductActiveStatustApprovalActionJob extends AbstractTrainingProductActiveStatusApprovalActionJob{


    private static final Logger LOGGER = LoggerFactory.getLogger(TrainingProductActiveStatustApprovalActionJob.class);
